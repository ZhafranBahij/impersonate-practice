                    ...
                    <tbody>
                        @forelse ($data as $note)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('note.show', $note->id) }}" class="btn btn-sm btn-info text-white"
                                        title="Show">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="{{ route('note.edit', $note->id) }}" class="btn btn-sm btn-warning text-white"
                                        title="Edit">
                                    ...
                                    <form action="{{ route('note.destroy', $note->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-sm btn-danger" onclick="return confirm('Delete this note?')"
